...
const { eventTypeCache } = require('../config/cache');
...
describe('buildPDF', () => {
  it('should generate a PDF with the correct header and validate finalY', () => {
    ...
    function buildPDF() {
      ...
      const description = 'This is the list of (Cached) Event Types that drive the Whatsfresh processing and data fetching.';
